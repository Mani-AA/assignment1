...
public class Client extends Thread { 
     ...
     */
     public void readTransactions()
     {
        ...
        System.out.println("\n  Client.readTransactions() - " + getNumberOfTransactions() + " transactions processed");
     ...
     */
     public void sendTransactions()
     {
         ...
         {  
            ...
            System.out.println("\n  Client.sendTransactions() - sending transaction on account " + transaction[i].getAccountNumber());
     ...
     */
     public void receiveTransactions(Transactions transact)
     {
         ...
         {     
            ...
            System.out.println("\n  Client.receiveTransactions() - receiving updated transaction on account " + transact.getAccountNumber());
