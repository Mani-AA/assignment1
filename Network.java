...
public class Network extends Thread {
     ...
     */
         public boolean send(Transactions inPacket)
        {
            ...
            System.out.println("\n  Network.send() - index inputIndexClient " + inputIndexClient);
            System.out.println("\n  Network.send() - account number " + inComingPacket[inputIndexClient].getAccountNumber());
            ...
            {	
            	...
            	System.out.println("\n  Network.send() - inComingBuffer status " + getInBufferStatus());
            }
            else
     ...
     */
         public boolean receive(Transactions outPacket)
        {
            ...
            System.out.println("\n  Network.receive() - index outputIndexClient " + outputIndexClient);
            System.out.println("\n  Network.receive() - account number " + outPacket.getAccountNumber());
            ...
            {	
            	...
            	System.out.println("\n  Network.receive() - outGoingBuffer status " + getOutBufferStatus());
            }
            else
     ...
     */
         public boolean transferOut(Transactions outPacket)
        {
            ...
            System.out.println("\n  Network.transferOut() - account number " + outGoingPacket[inputIndexServer].getAccountNumber());
            ...
            if ( getinputIndexServer( ) == getoutputIndexClient( ))
            {
                ...
                System.out.println("\n  Network.transferOut() - outGoingBuffer status " + getOutBufferStatus());
            }
            else
                setOutBufferStatus("normal");
     ...
     */
        ...
        {
		System.out.println("\n  Network.transferIn - account number " + inComingPacket[outputIndexServer].getAccountNumber());
            ...
            System.out.println("\n  Network.transferIn() - index outputIndexServer " + outputIndexServer);
            System.out.println("\n  Network.transferIn() - account number " + inPacket.getAccountNumber());
           ...
           /* Check if input buffer is empty */
            if ( getoutputIndexServer( ) == getinputIndexClient( ))
            {
                ...
                System.out.println("\n  Network.transferIn() - inComingBuffer status " + getInBufferStatus());
            }
            else
                setInBufferStatus("normal");
    ...
    public void run()
    {	
    	System.out.println("\n  Network.run() - starting network thread");
