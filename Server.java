...
public class Server extends Thread {
     ...
     */  
     public void initializeAccounts()
     {
        ...
        System.out.println("\n  Server.initializeAccounts() " + getNumberOfAccounts() + " accounts processed");
     ...
     */
     ...
     {   int accIndex;             	/* Index position of account to update */
         ...
         { 
        	 ...
        	 while((!objNetwork.getClientConnectionStatus().equals("disconnected")) && (objNetwork.getInBufferStatus().equals("empty"))) {
                 Thread.yield();
             }
        	 ...
        	 if (!objNetwork.getInBufferStatus().equals("empty"))
        	 {
        		 ...
        		 if (trans.getOperationType().equals("DEPOSIT"))
        		 {
        			 ...
        			 System.out.println("\n  Server.processTransactions() - Deposit of " + trans.getTransactionAmount() + " in account " + trans.getAccountNumber());
        		 }
        		 else
        			 ...
        			 if (trans.getOperationType().equals("WITHDRAW"))
        			 {
        				 ...
        				 System.out.println("\n  Server.processTransactions() - Withdrawal of " + trans.getTransactionAmount() + " from account " + trans.getAccountNumber());
        			 }
        			 else
         ...
         System.out.println("\n  Server.processTransactions() - " + getNumberOfTransactions() + " accounts updated");
    ...
    {   
    	...
    	System.out.println("\n  Server.run() - starting server thread " + objNetwork.getServerConnectionStatus());
    	
        processTransactions(trans);

        serverEndTime = System.currentTimeMillis();
        System.out.println("\n Terminating server thread - " + " Running time " + (serverEndTime - serverStartTime) + " milliseconds");
        objNetwork.disconnect("216.120.40.10");
    }
}
